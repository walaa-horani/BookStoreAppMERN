...
function Highlights() {
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 sm:gap-8 mt-10'>
       <div className="flex items-start gap-3 sm:mb-6 sm:justify-center  max-w-md w-full mx-auto">
  ...
  {/* Feature 2 */}
  <div className="flex items-start gap-3 sm:mb-6 sm:justify-center">
