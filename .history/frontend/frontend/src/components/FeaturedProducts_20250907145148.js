...
function FeaturedProducts() {
  ...
  return (
    <div className='mt-10'>
      ...
      <button  disabled={loading || book.stock === 0} onClick={()=> addToCart(book._id)} className="whitespace-nowrap w-44">{loading ? "Adding To cart" : book.stock=== 0 ? "Out Of stock":"Add To cart"}</button>
        </div>
        ))}
